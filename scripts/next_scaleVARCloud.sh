#!/bin/bash
#SBATCH -n 8 --gres=gpu:volta:1 -o output/next_scale_var-0006_VAR_32-true_fullvqvae_overflow.log-%j
...
MY_TASK_NAME=$MY_EXPERIMENT"-0005_VAR_32-true_fullvqvae"
MY_TASK_NAME=$MY_EXPERIMENT"-0006_VAR_32-true_fullvqvae_overflow"
...
#   +config_name=run_scale_var.yaml  # override @hydra.main(config_path="../configs/", config_name="run.yaml"